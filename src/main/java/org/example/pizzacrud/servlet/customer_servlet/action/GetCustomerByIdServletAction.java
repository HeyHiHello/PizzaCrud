...
public class GetCustomerByIdServletAction implements ServletAction {
    private final int id;
    private final HttpServletResponse response;
    private final CustomerService customerService;

    public GetCustomerByIdServletAction(int id, HttpServletResponse response) {
        this.id = id;
        this.response = response;
        customerService = ServiceBuilder.buildCustomerService();
    }

    public GetCustomerByIdServletAction(CustomerService customerService, int id, HttpServletResponse response) {
        this.id = id;
        this.response = response;
