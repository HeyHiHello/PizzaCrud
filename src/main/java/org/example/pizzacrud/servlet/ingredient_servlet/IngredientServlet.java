...
import org.example.pizzacrud.servlet.ingredient_servlet.action.IngredientServletActionBuilder;

import java.io.IOException;

@WebServlet("/api/ingredient/*")
public class IngredientServlet extends HttpServlet {
    ...
    public ServletActionBuilder getActionBuilder(HttpServletRequest req, HttpServletResponse resp) {
        return new IngredientServletActionBuilder(req, resp);
    }
}
